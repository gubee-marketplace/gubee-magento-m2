...
class After extends AbstractProduct
{
    ...
    protected function isAllowed(): bool
    {
        ...
        return !(isset($origJson['quantity_and_stock_status']) &&
        isset($origJson['quantity_and_stock_status']['qty']) && isset($origJson['quantity_and_stock_status']['is_in_stock']) && ($origJson['quantity_and_stock_status']['qty']
        ==
